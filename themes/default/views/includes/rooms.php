    ...
    <div class="rooms-update">
      <form  method="GET">
        ...
        <div class="col-md-2 col-lg-3 col-sm-2">
          <?php if(!empty($rooms)){ ?>
          <h4 style="margin-top: 30px;" class="text-center  size20"><strong><i class="icon_set_1_icon-83"></i><?php echo trans('0122');?></strong> <?php echo $modulelib->stay; ?> </h4>
          <?php } ?>
        </div>
      </form>
...
<script type="text/javascript">
        ...
        $('.zoom-gallery<?php echo $r->id; ?>').magnificPopup({
          ...
          <?php if(!empty($r->desc)){ ?><p><strong><?php echo trans('046');?> : </strong> <?php echo $r->desc;?></p> <?php } ?>
          <hr>
