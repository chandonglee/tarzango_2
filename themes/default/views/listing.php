  ...
  <form class="container" action="<?php echo base_url().$appModule;?>/search" method="GET">
    ...
    <div class="col-md-3 col-lg-4 col-sm-12 go-right">
      <div class="form-group">
        ...
        <div class="clearfix"></div>
        <select name="<?php if($appModule == 'hotels'){ echo 'searching';}else if($appModule == 'tours'){ echo 'location'; } ?>" class="chosen-select" style="background-color: white;" id="location" >
          <option value=""><?php echo trans('0447');?></option>
    ...
    <div class="col-md-2 col-lg-1 col-sm-6 col-xs-6 go-right">
      <div class="form-group">
        <div class="clearfix"></div>
        <label class="control-label go-right size13"><i class="icon-user-7"></i> <?php if($appModule == "hotels"){ echo trans('010'); }else if($appModule == "tours"){ echo trans('0446'); } ?></label>
...
<div class="container pagecontainer offset-0">
  ...
  <form  action="<?php echo base_url().$appModule;?>/search" method="GET" role="search">
    ...
    <div class="col-md-3 filters offset-0 go-right">
      ...
      <div class="filtertip">
        <div class="padding20">
          <h4 class="size24"><i class="icon_set_1_icon-95 go-right"></i><span class="go-right"><?php echo trans('0191');?></span> <span class="countprice"></span></h4>
        </div>
      </div>
      <!-- Star ratings -->
      <button type="button" class="collapsebtn go-text-right" data-toggle="collapse" data-target="#collapse1">
