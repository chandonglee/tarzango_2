...
<div class="bg_list_image">
  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 login-form" style="margin-bottom:100px;margin-top:100px">
    ...
    <form method="POST" action="" id="loginfrm" accept-charset="UTF-8" onsubmit="return false;">
      ...
      <div class="login-wrap">
        ...
        <div class="login-c1 wow fadeInDown animated">
          <div class="cpadding50">
            <div class="form-group">
              ...
              <input type="email" class="form-control input-lg padding-10"  placeholder="<?php echo trans('094');?>" required name="username">
            </div>
            <div class="form-group">
              <label><?php echo trans('095');?></label>
              <input type="password" class="form-control input-lg padding-10"  placeholder="<?php echo trans('095');?>" required name="password">
            </div>
          </div>
        </div>
              ...
              <div class="alignbottom2">
                <div class="checkbox">
                  <label class="go-right">
                    <input class="go-right" type="checkbox" name="remember" id="remember-me" value="1" style="    height: 15px !important;">
                    <span style="font-size:13px;color:#000"><span class="go-left"> &nbsp; <?php echo trans('0187');?> &nbsp; </span></span></label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="login-c3 wow zoomInDown animated" style="margin-top: 10px;position: relative;float: left;width: 100%;">
          ...
          <div class="left" style="width: 50%;float: left;"><a href="<?php echo base_url();?>register" class="whitelink"><span></span><?php echo trans('0237');?></a></div>
          <?php } ?>
...
<?php if($fblogin){ ?>
<div class="form-group"> <a href="<?php echo $fbloginurl;?>" class="btn btn-facebook btn-block"><i class="fa fa-facebook-square" ></i> <?php echo trans('0266');?></a> </div>
<?php } ?>
<?php } }  ?>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo trans('0112');?></h4>
      </div>
    ...
    border: none;
    letter-spacing: 1px;
    " class="btn btn-primary resetbtn" type="button">
            <?php echo trans('0114');?>
            </button>
            </span> </div>
        </form>
