...
<div class="control-group">
                ...
                <div class=" input-append date  form_date" >
                    <input size="16" class="date-block dpean3" type="text" value="<?php echo $checkin; ?>" >
...
<label> Check Out </label>
      ...
      <div class="control-group">
                ...
                <div class=" input-append date  form_date" >
                    <input size="16" class="date-block dpean4" type="text" value="<?php echo $checkOut; ?>" >
                    <span class="add-on"><i class="icon-remove"></i></span>
          <span class="add-on"><i class="icon-th"></i></span>
                </div>
        <br/>
...
<i class="fa fa-chevron-left"> </i> <input type="number" value="<?php echo $room; ?>" >  <i class="fa fa-chevron-right"> </i>
</div>
...
<label> Guests  </label>
<div class="input-next-previce"> 
<i class="fa fa-chevron-left"> </i> <input type="number"  value="<?php echo $adults; ?>" >  <i class="fa fa-chevron-right"> </i>
</div> 
