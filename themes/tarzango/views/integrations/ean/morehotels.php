...
<div class="row" style="margin-left:0px;margin-right:0px">
  <?php
    ...
    ?>
  <div class="offset-2">
        <div class="wow fadeInUp col-lg-8 col-md-8 col-sm-8 offset-0 go-right">
          <div class="img_list">
        ...
        <div class="wow fadeInUp col-md-4 offset-0">
          <div class="itemlabel3">
            
            <div class="labelleft2 rtl_title_home">
              <h4 class="mtb0 RTL go-text-right white_font">
                <a href="<?php echo $item->slug;?>" class="white_font" ><b><?php echo character_limiter($item->title,20);?></b></a>
            ...
            <div class="labelright go-left white_font" style="min-width:105px;margin-left:5px">
              ...
              <div class="review text-center size18 white_font"><i class="icon-thumbs-up-4"></i><?php echo $item->tripAdvisorRating;?> </div>
              <div class="clearfix"></div>
              <hr>
              <?php } } ?>
              <a href="<?php echo $item->slug;?>">
              <button type="submit" class="btn btn-action" style="background:yellow; color:black; font-weight:normal;" ><?php echo trans('0177');?></button>
              </a>
            </div>
          </div>
        </div>
