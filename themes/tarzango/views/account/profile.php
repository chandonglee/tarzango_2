...
<form action="" id="profilefrm" method="POST" onsubmit="return false;">
  ...
  <div class="col-sm-12">
    ...
    <a class="subscribed newsletter <?php if($is_subscribed){echo "news_active";}?> " data-issubscribed="1" >Subscribed <i class="fa fa-check" aria-hidden="true"></i></a> <a class="unsubscribed newsletter <?php if(!$is_subscribed){echo "news_active";}?> " data-issubscribed="0" >Unsubscribe <i class="fa fa-times" aria-hidden="true"></i></a> </div>
  <div class="col-sm-12">
