...
?>
  ...
  <div id="hotel_deta" style="z-index:9999999999"> </div>
  <div class="section6">
    <div class="container">
      <div class="row">
  ...
  <div class="section7">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-5"> <img class="img-responsive-xs mtop0" style="margin-top: -80px" src="images/membership-door.png"> </div>
        <div class="clearfix"></div>
      </div>
    </div>
  </div>
    ...
    //var hotel_id = $(this).data('hotel_id');
        ...
        if($('#sel_hotel_'+hotel_id).is(":checked")){
           // $("#sel_hotel").html(hotel_id);
            ...
            $("#sel_hotel_"+hotel_id).siblings(".sel_txt").html('Selected');
          ...
          $("#sel_hotel_"+hotel_id).siblings(".sel_txt").html('Select');
        ...
        success: function(data)
        {
          ...
          for (var i = 0;  i < response.hotel.length; i++) {
           ...
           if(hotel_name.length > 20){
            ...
            HTML_DATA += '<li class="card"><div class="">';  
            HTML_DATA += '<div class="box"><img  class="img-responsive" style="width:100%;" src="'+base_date.thumbnail.replace('http://demo.tarzango.com/','http://tarzango.com/')+'">';
            ...
            if(base_date.desc == ''){
              HTML_DATA += '<div class="row"><h2 class="col-md-6">$ '+base_date.price+'<span> / night</span></h2> <span class="col-md-6"><div class="checkbox-bg"><input class="verified sel_txt_chk" type="checkbox" id="sel_hotel_'+base_date.id+'" onClick="get_hotel('+1+','+base_date.id+',\''+base_date.title+'\')"><div  class="sel_txt"> Select</div></div></span><div class="clearfix"></div></div>'; 
            }else{
              HTML_DATA += '<div class="row"><h2 class="col-md-6">$ '+base_date.price+'<span> / night</span></h2> <span class="col-md-6"><div class="checkbox-bg"><input class="verified sel_txt_chk" type="checkbox" id="sel_hotel_'+base_date.id+'" onClick="get_hotel('+2+','+base_date.id+',\''+base_date.title+'\')"><div  class="sel_txt"> Select</div></div></span><div class="clearfix"></div></div>'; 
