...
<div class="text-center">
  <div class="container">
    <div class="col-sm-1 hideen-xs"> </div>
    <div class="inner_section col-sm-10 col-xs-12">
      ...
      <div class="contact-form">
        ...
        <form id="contact_form" action="" method="post">
          ...
          <div style="margin-bottom: 0px;" class="alert alert-success"> <i class="fa fa-check-square-o"></i> <?php echo @$successmsg; ?> </div>
          </br>
          <?php } if(!empty($validationerrors)){ ?>
          <div style="margin-bottom: 0px;" class="alert alert-danger"> <i class="fa fa-times-circle"></i> <?php echo $validationerrors; ?> </div>
          </br>
          <?php } ?>
