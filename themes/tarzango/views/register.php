        ...
        <div class="row">
          <div class="col-md-12">
            <div class="login-form">
              <div class="login-title"> <span class="text">Create Account</span></div> 
              ...
              <form  action="" method="POST" id="headersignupform" onsubmit="return false;">
                ...
                <div class="col-md-12">
                  <div class="input text-center">
                    <button type="submit" id="login_submit" class="signupbtn btn_full btn btn-action btn-block btn-lg submit-input btn-login" value=""> <?php echo trans('0115');?> </button>
                  </div>
                </div>
                <div class="clearfix"></div>
                </div>
