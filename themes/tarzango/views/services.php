...
{
  .Services_page_main .Services_page_cover .service_cont ul li .service_left{padding-right:3%}
}
@media(max-width:991px)
{
  .Services_page_main .Services_page_cover .service_cont ul li .service_left h3{margin-bottom:30px; font-size:34px;}
  .Services_page_main .Services_page_cover .service_cont ul li .service_left p{margin-bottom:60px;}
  .Services_page_main .Services_page_cover .service_cont ul li{padding:50px 0;} 
}
@media(max-width:820px)
{
  .member_ship .upgrade_membership h3::after{top:0px; right:0; background-size:90px auto;}
}

@media(max-width:768px)
{
  .Services_page_main .container{padding-right: 10px !important; padding-left: 10px !important;}
  .Services_page_main .Services_page_cover .service_cont ul li .service_right img{width:70%;}
}
@media(max-width:767px)
{
 
  .service_cont_slider .bxslider li .slider_img{width:100%}
  .service_cont_slider .bxslider li .slider_cont{width:100%; padding-left:0; margin-top:30px;}
  .service_cont_slider .bxslider li .slider_cont p{width:auto;}
 
}
@media(max-width:667px)
{
  .Services_page_main .Services_page_cover .service_cont ul li .service_right{float:left; width:100%; text-align:left;}
  .Services_page_main .Services_page_cover .service_cont ul li .service_left{width:100%; padding-right:0; text-align:left;}
  .Services_page_main .Services_page_cover .service_cont ul li .service_right img{width:auto;}
}
@media(max-width:568px)
{
  .service_cont_slider .bxslider li .slider_cont h3{font-size:40px; line-height:36px;}
  .service_cont_slider .bxslider li > h3{font-size:24px;}
  .service_cont_slider .bxslider li .slider_cont p{font-size:36px;}
  .service_cont_slider .bxslider li .slider_cont spam{margin-top:5px;}
}
@media(max-width:480px)
{
  .Services_page_main .Services_page_cover .service_cont ul li .service_left h3{font-size:25px;}
}
@media(max-width:414px)
{
  .Services_page_main .Services_page_cover .service_cont ul li .service_right img{width:190px;margin-left: 80px;}
  .Services_page_main .Services_page_cover .service_cont ul li .service_left h3{font-size:21px; margin-top:0;text-align: center;
}}
  .Services_page_main .Services_page_cover .service_cont ul li .service_right{padding:0 0 40px;}
}
                	...
                	<li>
                    	<div class="container">
                            <div class="service_right">
                                <img src="images/event_housing.png">
                            </div>
                            <div class="service_left">
                                ...
                                <a class="service_btn" href="<?php echo base_url().'groupbooking'; ?>">Learn More</a>
                            </div>
                        </div>
                    </li>
                    <li>
                    	<div class="container">
                            ...
                            <div class="service_left">
                                ...
                                <a class="service_btn" href="<?php echo base_url();?>">find your hotel</a>
                            </div>
                        </div>
                    </li>
                    <li>
                    	<div class="container">
                            ...
                            <div class="service_left">
                                ...
                                <a class="service_btn" href="<?php echo base_url().'attraction'; ?>">Attractions</a>
                            </div>
                        </div>
                    </li>
                    <li>
                    	<div class="container">
                            ...
                            <div class="service_left">
                                ...
                                <a class="service_btn">Coming soon</a>
                            </div>
                        </div>
                    </li>
                    <li>
                    	<div class="container">
                            <div class="service_right">
                                <img src="images/travell_gear.png">
                            </div>
                            <div class="service_left">
                                <h3>Travel Gear</h3>
                         ...
                         <li>
                          <h3>Hotels Just Booked.</h3>
                            <div class="slider_img"  >
                                <img  src="<?php echo str_replace($img_ary_repla, "",  $recent_book[$r_b]->thumbnail); ?>" />
                            </div>
                            <div class="slider_cont">
                                <span> <?php echo $recent_book[$r_b]->stars; ?></span>
