...
<div class="section4">
      <div class="container">
          ...
          <form class="container form_header_one" action="" method="GET" role="search">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <input type="text" style="font-size: 16px !important;" placeholder=" <?php echo trans('07');?>" name="checkIn" class="dpean1 form-control" value="09/20/2016" required >
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                 <input type="text" style="font-size: 16px !important;" class="form-control dpean2" placeholder=" <?php echo trans('09');?>" name="checkOut" value="09/24/2016" required >
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          //var HTML_DATA = '';
            ...
            HTML_DATA += '<div class="section5"><div class="container"> <div class="row">  <div class="col-sm-12">            <h1>These are the top '+response.hotel.length+' results we found near '+city+'</h1> <div class="col-sm-4"><div id="slider" style="">    <ul style="position:relative; width:100%;  float:left; height:600px; z-index:1; ">';
          ...
          for (var i = 0;  i < response.hotel.length; i++) {
           ...
           if(hotel_name.length > 20){
            ...
            HTML_DATA += '<li class="card"><div class="col-sm-4">';  
            HTML_DATA += '<img  class="img-responsive" style="width:100%;" src="'+base_date.thumbnail.replace('http://demo.tarzango.com/','http://tarzango.com/')+'"><div class="box">';
            ...
            if(base_date.desc == ''){
              HTML_DATA += '<h2>$ '+base_date.price+'<span> / night</span></h2><div style="background-color:#cee8fa"> <span style="float:right;"><input style="width: 25px; background:#fff" class="verified" type="checkbox" id="sel_hotel_'+base_date.id+'" onClick="get_hotel('+1+','+base_date.id+',\''+base_date.title+'\')"><div style="margin-left: 10px;float: right;margin-top: 23px;"> Select</div></span></div'; 
            }else{
              HTML_DATA += '<h2>$ '+base_date.price+'<span> / night</span></h2> <div style="background-color:#cee8fa"><span style="float:right;" ><input style="width: 25px; background:#fff" class="verified" type="checkbox" id="sel_hotel_'+base_date.id+'" onClick="get_hotel('+2+','+base_date.id+',\''+base_date.title+'\')"><div style="margin-left: 10px;float: right;margin-top: 23px;"> Select</div></span></div>'; 
