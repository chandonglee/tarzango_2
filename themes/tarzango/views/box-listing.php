               ...
               ?>
                ...
                <div class="col-sm-9 view-options" style="width: 73.8%">
                  ...
                  <a class="" id="box-listing" href="<?php echo $complete_url1; ?>">
                    <?php if($complete_url1 == $complete_url_final){ ?>
                    <img src="images/header-list-icon-active.png">
                    <?php }else{ ?>
              ...
              <div class="col-lg-4 col-md-4 " style="margin-bottom:20px">
                <div class="list-box">
                  <div class="hotel-image">
                    ...
                    <?php }else{ if ( !empty($final_hb_img) && $final_hb_img[$item->id]['sThumbnail'] != "" ) {
                ...
                <img class="img-responsive" src="<?php echo $img_main_url.$img_list[$h_img]->path; ?>">
                  ...
                  <div  class="hotel-detail-main">
                    ...
                    <div style="max-height:160px;min-height:160px" class="hotel-description">
                      <p><?php echo character_limiter($item->desc,220);?> </p>
                    </div>
...
var userList = new List('list-view-therd', options);
