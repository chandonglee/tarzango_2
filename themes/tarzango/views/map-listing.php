          ...
          <div class="container" >
            <div class="row col-sm-6" >
              <div class="col-sm-12">
               ...
               ?>
                <div class="col-sm-6 sorting recommended">
                ...
                <div class="col-sm-6 sorting popularity" style="display: none">
                  <label class="title map_views">Popularity <img src="images/arrow-down.png"><img src="images/arrow-up.png"></label>
                  <div class="dropdown " style="z-index:999999999">
                    <button class="sort stars_p" data-sort="stars" style="">Popularity</button>
                    <a id="map-listing" href="<?php echo $complete_url3; ?>">Recommended</a>
                    <button class="sort distance-d" data-sort="distance">Distance</button>
                ...
                <div class="col-sm-6 sorting distance_div" style="display: none">
                  <label class="title map_views">Distance <img src="images/arrow-down.png"><img src="images/arrow-up.png"></label>
                  <div class="dropdown " style="z-index:999999999">
                    <button class="sort stars_p" data-sort="stars" style="">Popularity</button>
                    <a id="map-listing" href="<?php echo $complete_url3; ?>">Recommended</a>
                    <button class="sort distance-d" data-sort="distance">Distance</button>
