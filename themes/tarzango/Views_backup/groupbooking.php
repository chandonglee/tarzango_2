            ...
            <div class="col-sm-8">
              <h1>Fill out the form below</h1>
               ...
               <form class="" id="booking_data_final1" method="POST" name="">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <input type="text" id="datepicker1" style="font-size: 16px !important;" name="check_in" class="form-control" placeholder="DD/MM/YYYY">
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                     <input type="text" id="datepicker2" style="font-size: 16px !important;" name="check_out" class="form-control" placeholder="DD/MM/YYYY">
                  </div>
                </div>
                <div class="col-sm-8">
                  <div class="form-group">
                     <input type="text" name="g_attendees" value="" class="form-control" id="g_attendees" placeholder="Number of anticipated attendees">
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="form-group">
                ...
                <div class="col-sm-8">
                  <div class="form-group">
                    <input type="text" name="g_city" value="" class="form-control" id="g_city" placeholder="Preferred City">
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="form-group">
                   <input type="text" name="g_state" value="" class="form-control" id="g_state" placeholder="State">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
  ...
  //$(document).ready(function(){
      ...
      $.ajax({
        ...
        success: function(data)
        {
          response = $.parseJSON(data);
          var HTML_DATA = '';
            HTML_DATA += '<div class="section5"><div class="container"><div class="row"><div class="col-sm-12">';
          for (var i = 0;  i < response.length; i++) {
            var base_date = response[i];
            HTML_DATA += '<div id="hotel_'+base_date.id+'" style="float:left;">';
            HTML_DATA += '<div><img height="200px" width="200px" src="'+base_date.thumbnail+'"></div>';
            HTML_DATA += '<div>'+base_date.title+'</div>';
            HTML_DATA += '<div>'+base_date.stars+'<br> '+base_date.room_Data[0].maxQuantity+' avalible room <br>'+ base_date.distance+' miles from '+city +'</div>';
            HTML_DATA += '<div>'+base_date.price+'/ per night <input onClick="get_hotel('+base_date.id+',\''+base_date.title+'\')" type="checkbox" data-hotel_id="'+base_date.id+'" id="sel_hotel_'+base_date.id+'" name="sel_hotel"></div>';
            HTML_DATA += ' <select class="form-control" onChange="add_room('+base_date.id+',\''+base_date.title+'\')" name="" id="sel_hotel_room_'+base_date.id+'">';
            ROOM_DATA = '';
            for (var j = 0; j < base_date.room_Data[0].maxQuantity; j++) {
                ROOM_DATA += '<option value="'+j+'">'+j+'</option>';
            }
               HTML_DATA +=  ROOM_DATA;
               HTML_DATA +=  '</select>';
            HTML_DATA += '</div>';
