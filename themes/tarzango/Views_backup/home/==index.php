...
<div class="container-fluid planning">
  <div class="container">
    <div class="row">
      <div class="row book-detail">
        ...
        <div class="col-sm-4">
          <figure> <img src="<?php echo $theme_url; ?>img/icon-hotel.png" alt="Hotel"> 
          </figure>
          <h5>
           <div style="text-align:center;">
            <span style="position: absolute;vertical-align: middle;margin-left: 52px;margin-top:-10px; width: 70px;height: 2px;background: #ffc3df;"></span>
           Hotel Negotiator
          </div>
          </h5>
        ...
        <div class="col-sm-4">
          ...
          <h5>
          <div style="text-align:center;">
            <span style="position: absolute;vertical-align: middle;margin-left: 50px;margin-top:-10px; width: 70px;height: 2px;background: #ffc3df;"></span>
            Concierge Team
          </div>
        ...
        <div class="col-sm-4">
          ...
          <h5><div style="text-align:center;">
            <span style="position: absolute;vertical-align: middle;margin-left: 28px;margin-top:-10px; width: 70px;height: 2px;background: #ffc3df;"></span>
            White Label
          </div>
         </h5>
  ...
  <div class="hotel-btn-space"> <a href="#" title="Let’s get Started" class="pink-btn">Let’s get Started</a></div>
</div>
<div class="container-fluid how-section">
  <div class="container">
    <h2>How?</h2>
    <h4>Choose a hotel in our database, and simply, tell us the amount 
      of rooms you need. Book. Confirm. Then Relax!</h4>
    <a href="#" title="group booking" class="pink-btn">group booking</a> </div>
</div>
<div class="container-fluid facilities">
  <div class="container">
    <h2>Why Tarzango? Well.</h2>
    <h4>We provide a modern way for Group Travelers to book large room blocks.</h4>
    <div class="row">
      <div class="col-sm-6 col-lg-6 col-sm-offset-5 text-left">
        <ul>
          <li> <i><img src="<?php echo $theme_url; ?>img/tier1.png" alt="" title="" /></i> <a href="#">
            <figure> <img src="<?php echo $theme_url; ?>img/icon/1.png" alt="" title="" /> </figure>
            <p><b>Get access to hotels at a discounted price</b></p>
            </a> </li>
          <li> <a href="#">
            <figure> <img src="<?php echo $theme_url; ?>img/icon/2.png" alt="" title="" /> </figure>
            <p><b>Keep track of your bookings</b></p>
            </a> </li>
          <li> <i><img src="<?php echo $theme_url; ?>img/tier2.png" alt="" title="" /></i> <a href="#">
            <figure> <img src="<?php echo $theme_url; ?>img/icon/3.png" alt="" title="" /> </figure>
            <p><b>Take a additional 10% off all Bookings</b></p>
            </a> </li>
          <li> <a href="#">
            <figure> <img src="<?php echo $theme_url; ?>img/icon/4.png" alt="" title="" /> </figure>
            <p><b>Cut the line & enjoy VIP check in</b>- selected hotels</p>
            </a> </li>
          <li> <a href="#">
            <figure> <img src="<?php echo $theme_url; ?>img/icon/5.png" alt="" title="" /> </figure>
            <p><b>Complimentary upgraded Rooms</b>- selected hotels</p>
            </a> </li>
          <li> <a href="#">
            <figure> <img src="<?php echo $theme_url; ?>img/icon/6.png" alt="" title="" /> </figure>
            <p><b>Airport to Hotel Drop Off in SUV</b>- selected cities</p>
            </a> </li>
          <li> <a href="#">
            <figure> <img src="<?php echo $theme_url; ?>img/icon/7.png" alt="" title="" /> </figure>
            <p><b>Dedicated concierge rep to assist with making 
              reservations & planning your stay.</b></p>
            </a> </li>
          <li>
            <figure> <img src="<?php echo $theme_url; ?>img/icon/8.png" alt="" title="" /> </figure>
            <p><b>Front in the line access to Air and rental cars "Coming Soon" </b></p>
           </li>
          <li> <a class="pink-btn" title="Become a  member" href="#">Become a  member</a> </li>
        </ul>
      </div>
    </div>
  </div>
