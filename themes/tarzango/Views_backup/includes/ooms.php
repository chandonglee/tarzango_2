    ...
    <?php foreach($rooms as $r){ if($r->maxQuantity > 0){ ?>
      ...
      <div class="room-row" style="">
        <div class="room-row-line">
          <div class="room-type-name"> <?php echo $r->title;?> </div>
        ...
        <div class="room-detail" id="collapse<?php echo $r->id; ?>" style="display:none">
          <div class="row">
            <div class="col-lg-6 col-sm-6 col-md-6"> <img class="img-responsive" src="<?php echo str_replace("demo.", "", $r->thumbnail);?>"> </div>
