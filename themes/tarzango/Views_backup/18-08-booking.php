...
<?php  }else{ ?>  
  ...
  <div class="container-main main_header">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="col-sm-1 inner_logo pull-left">
            <a href=""><img class="" src="images/logo.png"></a>
          </div>
          <div class="col-sm-1 inner_menu pull-right">
...
<?php if(empty($usersession)){ ?>
            ...
            <div class="col-sm-7 col-xs-12 left-section">
              <ul class="nav nav-tabs responsive" id="myTab">
                <li class="col-sm-4 active"><a data-toggle="tab" href="#signin">Sign In</a></li>
                <li class="col-sm-4"><a data-toggle="tab" href="#sign_up">Sign Up</a></li>

                <li class="col-sm-4"><a data-toggle="tab" href="#book-guest">Book as a Guest</a></li>
              </ul>
              <div class="tab-content">
                ...
                <div id="sign_up" class="tab-pane fade">
                  <form class="" name="signup" id="signup" method="post">
                    <div class="col-sm-12">
                      <div class="form-group">
                ...
                <div id="book-guest" class="tab-pane fade">
                  <form class="" name="book_guest" id="book_guest" method="post">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group submit-button">
                      <button type="submit" style="" class="btn btn-action btn-lg btn-block completebook" name="<?php if(empty($usersession)){ echo "guest";}else{ echo "logged"; } ?>"  onclick="return completebook('<?php echo base_url();?>','<?php echo trans('0159')?>');"><?php echo trans('0306');?></button>
                      <!--
                  ...
                  <div class="col-sm-12 checkin-details">
                    ...
                    // Create Date Format
                     ...
                     $date = date_create($module->checkin); 
                              $date_new = date_format($date,"M/m/Y/D");
                              $chekin_date = explode("/",$date_new);
                              
                              
                              $date1 = date_create($module->checkout); 
                              $date_new1 = date_format($date1,"M/m/Y/D");
        ...
        <div class="col-md-8 pagecontainer2 offset-0 go-right" style="margin-bottom:50px;">
          <div class="panel-body">
            ...
            <div class="form-group">
             ...
             <!--
              <button type="submit" style="background: url(<?php echo $theme_url; ?>img/btn-bg.jpg); background-size:100%; " class="btn btn-action btn-lg btn-block completebook" name="<?php if(empty($usersession)){ echo "guest";}else{ echo "logged"; } ?>"  onclick="return completebook('<?php echo base_url();?>','<?php echo trans('0159')?>');"><?php echo trans('0306');?></button>
-->
            </div>
