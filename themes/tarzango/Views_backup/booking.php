...
<?php if(empty($usersession)){ ?>
            ...
            <div id="loggeduserdiv col-sm-10">
              <form id="loggedform">
            ...
            <?php } ?>
              <button type="submit" style="" class="btn btn-action btn-lg  completebook" name="<?php if(empty($usersession)){ echo "guest";}else{ echo "logged"; } ?>"  onclick="return completebook('<?php echo base_url();?>','<?php echo trans('0159')?>');"><?php echo trans('0306');?></button>
