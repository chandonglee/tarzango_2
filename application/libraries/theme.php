...
class Theme
{
    ...
    $this->_data     = array('theme_url' => $uu.$ptheme.'/','themeurl' => 'themes/'.$ptheme.'/','customerloggedin' => $this->_ci->session->userdata('pt_logged_customer'),'firstname' => $this->_ci->session->userdata('fname'), 'currency' => $currencyCode ,'is_member' => $this->_ci->session->userdata('is_member'));
