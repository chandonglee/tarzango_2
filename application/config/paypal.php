 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'ravi-facilitator_api1.atoatechnologies.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'V8ZY8F6VEMZPX827' : 'PRODUCTION_PASSWORD_GOGES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AOmJpQhnHTdRA62BF4k9z3WcVuoQA1jVnEQnKjmLZPDdcig139cpV30Q' : 'PRODUCTION_SIGNATURE_GOGES_HERE';
...
$config['DeviceID'] = '';
$config['DeviceIpAddress'] = $_SERVER['SERVER_NAME'];
