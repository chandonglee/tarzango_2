...
// check availability of module
		...
		function enable_main_module_hotelbeds($menutitle) {
				
				$data1 = array('is_avalible' => '1');
				$this->db->where("pt_hotel_beds_id", '1');
				$this->db->update("pt_hotel_beds", $data1);
				
		}

		function disable_main_module_hotelbeds($menutitle) {
				
				$data1 = array('is_avalible' => '0');
				$this->db->where("pt_hotel_beds_id", '1');
				$this->db->update("pt_hotel_beds", $data1);
