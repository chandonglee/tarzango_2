           ...
           /*$refNo = $this->bookings_model->getBookingRefNo($id);
            ...
            if ($bookingtype == "hotels") {
             ...
             if($status == "paid"){
              ...
              $checkin = date('Y-m-d',strtotime($invoicedetails->checkin));
              $checkout = date('Y-m-d',strtotime($invoicedetails->checkout));
              
              $this->update_ava_in_room($checkin,$checkout,$invoicedetails->subItem->id,$invoicedetails->subItem->quantity);
              ...
              $this->emails_model->paid_sendEmail_owner($invoicedetails,$this->data['app_settings'][0]->site_title);
                ...
                $this->update_ava_in_room_can($checkin,$checkout,$invoicedetails->subItem->id,$invoicedetails->subItem->quantity);
             }
