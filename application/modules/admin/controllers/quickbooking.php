...
class Quickbooking extends MX_Controller {
        ...
        function index() {
                ...
                if (!empty ($booknow)) {
                        ...
                        $booking_data = $this->bookings_model->doQuickBooking($customer); 
                        }
                        else {
                        $booking_data =  $this->bookings_model->doGuestBooking('quick'); 
                        }

                        //redirect(base_url() . "admin/bookings");
                        $b_url = $booking_data['url'];
                        $b_url = str_replace("invoice?id=", 'admin/bookings/edit/hotels/', $b_url);
