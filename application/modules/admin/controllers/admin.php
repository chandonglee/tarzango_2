				...
				if ($license || in_array($_SERVER['REMOTE_ADDR'], $whitelist) || $_SERVER['HTTP_HOST'] == "server") {
						if ($this->validadmin()) {
								...
								$this->data['yesterdayPaid'] = modules :: run('admin/reports/diffLastDurationPaid','1');
								 $this->data['todayPaid'] = modules :: run('admin/reports/diffLastDurationPaid','-1');
								...
								$modules->ean = (object)array("name" => "Expedia & Hotelbeds", "data" => $this->data['graphReportExpedia']['amounts']);
