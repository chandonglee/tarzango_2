        ...
        <div class="col-md-6">
          ...
          <div class="col-md-5">
             <p><strong><?php echo $invoice[0]->book_hotel;?></strong></p>
                <strong><?php echo trans('098');?> : </strong> <?php echo $invoice[0]->book_hotel;?> <?php echo $invoice[0]->book_location;?>
              </div>



<img src="<?php echo $invoice[0]->book_thumbnail; ?>">
          <div class="clearfix"></div>
          <div class="panel-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-condensed">
                        ...
                        <tbody>
                          ...
                          <td class="text-center"><?php $book_response = json_decode($invoice[0]->book_response); echo count($book_response->hotel->rooms[0]->paxes); ?></td>   
