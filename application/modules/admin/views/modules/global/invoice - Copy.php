      ...
      <div class="modal-body">
        <div role="form">
          ...
          <div class="col-sm-12">
            ...
            <center>
              <div  id="response"></div>
              <div  id="response1" style="display:none;"><a id="element_id_1470283648"></a></div>
            </center>
          </div>
          <div class="clearfix"></div>
...
PayStand.script.src = 'https://sandbox.paystand.co/js/gen/checkout.min.js';
...
$(function(){
    ...
    $("#gateway").on("change",function(){
      ...
      if(response.gateway == "paystand"){
          ...
          var paystand = '<a id="element_id_1470283648"></a>'; */
          $("#response1").show();
       }else{
         $(".creditcardform").hide();
