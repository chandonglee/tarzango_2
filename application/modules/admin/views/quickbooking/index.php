    ...
    <div class="panel panel-default">
     ...
     <div class="panel panel-default">
      ...
      <!-- Tours-->
        ...
        <div class="col-md-3">
        <textarea class="form-control " id="booking_additional_notes"  name="booking_additional_notes">
        ...
        <div class="panel panel-default  "  style="display:none;">
          ...
          <label class="col-md-3 control-label" id="" >Payment Type</label>
				 <div class="col-md-4 add_link" data-paystandimg="<?php echo base_url().'assets/img/paystand_logo.png'; ?>">
				    <select name="paymethod"  class="form-control sel_pay" data-placeholder="Select" >
                 <option value="">Select</option>
                  <?php foreach($paygateways['activeGateways'] as $payt){ 
                    if($payt['name'] != "moneybookers") {
                    ?>
