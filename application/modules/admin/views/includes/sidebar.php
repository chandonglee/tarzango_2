    ...
    <div class="menu">
      <div class="menu-content">
        <ul id="social-sidebar-menu">
          ...
          <!--<li <?php if($pagename == "admin/updates"){ ?> class="open" <?php } ?> >
          ...
          <?php } } ?>
          <li <?php if($pagename == "accounts"){ ?> class="open" <?php } ?> >
            ...
            <ul id="<?php echo trans('017');?>" class="collapse wow fadeIn animated <?php if($pagename == "accounts"){ echo "in"; }?>" >
              <?php if($role != "admin"){ ?>
          ...
          <?php if($isSuperAdmin){ ?>
          <li <?php if($pagename == "settings"){ ?> class="open" <?php } ?> >
            ...
            <ul id="menu-ui" class="collapse wow fadeIn animated <?php if($pagename == "settings"){ echo "in"; }?>">
          ...
          <li <?php if($pagename == "cms"){ ?> class="open" <?php } ?> >
            ...
            <!-- BEGIN SUB-ELEMENT MENU-->
            <ul id="CMS" class="collapse wow fadeIn animated <?php if($pagename == "cms"){ echo "in"; }?> ">
              <li>
          ...
          <li>
            <a href="<?php echo base_url().$this->uri->segment(1);?>/calender/"><i class="fa fa-list"></i>
            <span>Calender</span><span class="pull-right label label-danger" id=""></span>
            </a>
          </li>
          <?php } ?>
        </ul>
