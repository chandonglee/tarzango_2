      ...
      <tbody>
        <?php $moduleslist = $this->ptmodules->read_config();
          foreach($moduleslist as $modlist){
            if($modlist['Name'] == 'hotelbeds'){
              $isenabled = $this->ptmodules->is_main_module_enabled_hotel_beds(strtolower($modlist['Name']));
            }else{
        ...
        <tr>
          ...
          <td align="center">
            ...
            <?php } 
             if (strtolower($modlist['Name']) == "ean" && $isenabled) { ?>
        ...
        <tr>
          ...
          <td align="center">
            ...
            <?php } 
            if($mod->module_name != "coupons" && $modlist['Name'] != "hotelbeds" ){
            ?>
