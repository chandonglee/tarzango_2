...
function paypalpaymentspro_capture($params, $auth = "") {
	...
	$paymentvars['EXPDATE'] = $params['expMonth'].$params['expYear'];
	...
	$paymentvars['STREET'] = '707 W. Bay Drive';
	$paymentvars['CITY'] = 'Largo';
	$paymentvars['STATE'] = 'FL';
	$paymentvars['ZIP'] = '33770';
	$paymentvars['COUNTRYCODE'] = 'US';
