...
function paypalexpress1_link($params) {
		...
		$postfields['L_PAYMENTREQUEST_0_NAME0'] = $params['description'];
		$postfields['L_PAYMENTREQUEST_0_QTY0'] = "1";
		$postfields['RETURNURL'] = base_url(). "properties/hb_p_success?invoiceid=".$params['invoiceid'];
		$postfields['CANCELURL'] = base_url(). "properties/hb_p_failed?invoiceid=".$params['invoiceid'];
		$results = paypalexpress_api_call( $params, "SetExpressCheckout", $postfields );
		$ack = strtoupper( $results['ACK'] );
