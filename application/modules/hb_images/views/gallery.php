  ...
  <div class="panel-body">
    ...
    <table class="table table-striped table-hover">
      ...
      <?php
        ...
        if(!empty($images[0]->iHotelID)){

        foreach($images as $img): ?>
      <tr  id="tr_<?php echo $img->iImageID;?>">
        <td><a href="<?php echo $thumbsDir.$img->sHbHotelImage;?>" rel=""> <img width="120" height="80" src="<?php echo $thumbsDir.$img->sHbHotelImage;?>" href="<?php echo $fullImgDir.$img->sHbHotelImage;?>" class="img-responsive colorbox"></a></td>
        
        <td style="padding:35px">
       <?php if(in_array( $img->sHbHotelImage, $hbhotels)): ?>
          <button class="btn btn-primary btn-block btn-md btnthumb" id="<?php echo $img->sHbHotelImage;?>"> Yes </button>
         <?php else: ?>
          <button class="btn btn-default btn-block btn-md btnthumb" id="<?php echo $img->sHbHotelImage;?>"> No </button>
         <?php endif; ?>
      </td>

        <td style="padding:35px"><button class="btn btn-danger btn-block btn-md deleteImg" style="width: 42%;margin: 0 auto;" id="<?php echo $img->iImageID;?>" name="<?php echo $img->sHbHotelImage;?>" > Delete </button></td>
      </tr>
      <?php endforeach; ?>
        </tbody>
