<?php
class Attraction_model extends CI_Model {
        public $langdef;
		...
		function update_payment_status($pay_data = null,$pt_attr_booking_id,$booking_ref_no){
			$bookingdata = array(
							'booking_status' => 'paid',
		...
		function update_attr_booking($data,$id){
			$this->db->where('pt_attr_booking_id',$id);
    		$this->db->update('pt_attr_booking',$data);
    		/*echo $this->db->last_query();*/
		}
