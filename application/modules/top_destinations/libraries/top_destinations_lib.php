...
//get the CI instance
		...
		function set_hotelid($hotelslug) {
				$this->db->select('top_destinations_id');
				$this->db->where('top_destinations_id', $hotelslug);
				$r = $this->db->get('top_destinations')->result();
			    $this->top_destinations_id = $r[0]->hotel_id;

		}

		function get_id() {
				return $this->top_destinations_id;
		}
...
// get hotel rooms with limited details
 ...
 // Room Price
		...
		function hotel_details() {
            ...
            'defcheckin' => $defcheckin, 'defcheckout' => $defcheckout,'metadesc' => $metadesc,'keywords' => $keywords,'policy' => $policy,'tripadvisorid' => $tripadvisorid,'hotelAddress' => $details[0]->hotel_map_city);
   ...
   hotel_trusted,hotel_best_price,hotel_stars,hotel_slug,hotel_refundable,hotel_ratings,hotel_arrivalpay,thumbnail_image,hotel_amenities,hotel_latitude,hotel_longitude,hotel_meta_keywords,hotel_meta_desc');
	...
	//			$this->discountprice = $pricing['discount'];
			 ...
			 //	$this->country = $location[0]->short_name;
				...
				$this->location_1 = $details[0]->hotel_map_city;
...
// List 2 top rated hotels from each city passed to to this function
        ...
        //make a result object of Rooms Array
         ...
         /*   print_r($availQuantity);
          ...
          exit();*/
            ...
            $price = $curr->convertPrice($roomprice['perNight'],0);

            /*echo  $roomprice['maxAdults'] .">=". $this->adults ."&&". $roomprice['maxChild'] .">=". $this->children;
            exit();*/
        ...
        //make a result object of Rooms Array
         function getBookResultObject($hotelid,$roomid,$roomscount,$extrabeds = 0,$checkin = null,$checkout = null){
            ...
            /*echo $roomscount;
            exit();*/
            $roomscount = isset($roomscount) && $roomscount > 0 ? $roomscount : '1';
