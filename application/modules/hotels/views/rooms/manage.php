    ...
    <div class="panel-body"> <br>
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          ...
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Group booking price</label>
            <div class="col-md-2">
              <input class="form-control" type="number" placeholder="Group booking price" name="bedcharges"  value="<?php echo @$rdata[0]->extra_bed_charges;?>">
            </div>
          </div>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="AMENITIES">
          <div class="row form-group">
            <div class="col-md-12">
              ...
              <div class="col-md-4">
                <label class="pointer">
                  <input class="checkboxcls" <?php if($submittype == "add"){ if( $ramenity->sett_selected == "1"){echo "checked";} }else{ if(in_array($ramenity->sett_id,$roomamenity)){ echo "checked"; } } ?> type="checkbox" name="roomamenities[]" value="<?php echo $ramenity->sett_id;?>"  >
                  <?php echo $ramenity->sett_name;?></label>
              </div>
              <?php } ?>
            </div>
          </div>
