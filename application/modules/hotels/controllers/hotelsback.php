					...
					elseif ($args == "manage" && !empty ($editroom)) {
					   ...
					   //	 $datefmt = $this->input->post('dateformat');
						...
						$this->load->view('admin/template', $this->data);
							...
							$xcrud->label('room_title','Name')->label('pt_hotels.hotel_title','Hotel')->label('room_basic_price','Price')->label('room_quantity','Qty')->label('room_status','Status');
