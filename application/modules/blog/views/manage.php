        ...
        <div class="tab-content">
          <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
            <div class="col-md-12">
              ...
              <div class="col-md-8">
                <div class="form-group ">
                  <label class="required">Permalink : <?php echo base_url();?>/blog/</label>
                  <br>
            ...
            ?>
                    ...
                    <div class="col-md-6">
                      <div class="form-group ">
                        <label class="required">Top Destinations</label>
                        <select data-placeholder="Select" name="top_destinations_id" class="form-control" tabindex="2" required>
                          <option value="">Select</option>
                          <?php foreach($top_destinations as $cat){ ?>
                          <option value="<?php echo $cat->top_destinations_id;?>" <?php if(@$pdata[0]->top_destinations_id == $cat->top_destinations_id){ echo "selected"; } ?> > <?php echo $cat->name;?> </option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
