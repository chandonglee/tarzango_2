 ...
 function completebook(url, msg) {
     ...
     if (mem_type != "cont_as_free" && mem_type != 'already_member') {
         $.post(url + "admin/ajaxcalls/processMemberignup", $("#bookingdetails, #" + formname + "form , #vip_details").serialize(), function(response) {
...
console.log(mem_type);
 ...
 $("#selectFrom").click(function(){
    ...
    if ( $("#pickup_flight_code").val() == "") {
        ...
        return false;
    }*/ else if ( $("#drp_flight_code").val() == "") {
        $("#err_drp_code").text('Please enter departure flight code');
        return false;
    } /*else if ( $("#flight_dep_terminal").val() == "") {
